 ...
 **Getting OneShot**
 ```
 sudo wget https://raw.githubusercontent.com/shubham-indalkar/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 sudo wget https://raw.githubusercontent.com/shubham-indalkar/OneShot/master/vulnwsc.txt
 ```
...
#### Using installer
 ```
 curl -sSf https://raw.githubusercontent.com/shubham-indalkar/OneShot/master/OneShot_Termux_installer/installer.sh | bash
 ```
#### Manually
**Installing requirements**
 ```
...
**Getting OneShot**
 ```
 git clone --depth 1 https://github.com/shubham-indalkar/OneShot OneShot
 ```
#### Running
 ```
